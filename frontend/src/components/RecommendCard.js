...
function CustomCard(props) {
    ...
    return (
        <div className="site-card-wrapper" style={{ position: 'relative' , bottom: props.partOf ? 60 : -10, left: 0}}>
            <Row gutter={32}>
            {
                _.zipWith(props.booksData, props.authors, function(book, author) {
                    ...
                    return (
                        ...
                        <Col>
                            ...
                            {bookToDetail ?<RecommendDetails visible={modalVisible} updateModalVisible={updateModalVisible} averagerating={avgrate} {...bookToDetail} /> : null}
